...
def main():
    ...
    # plot.set_title("Single Thread Efficiency: YespowerSugar Performance on Ryzen 1700 (stock)\n Version=1.0.1 N=2048 r=32, using 8192.00 KiB RAM")
    plot.set_title("Single Thread Efficiency: YespowerSugar Performance\n CPU: Ryzen 1700(stock), RAM: DDR4 2400 MT/s\n Version=1.0.1 N=2048 r=32, Using 8192.00 KiB RAM")
